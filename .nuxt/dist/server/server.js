...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(22)["URLSearchParams"]))
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/TheFooter.vue?vue&type=template&id=1e23a034&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('footer',[_vm._ssrNode("<div class=\"flex flex-col items-center mt-16\"><div class=\"flex mb-3 space-x-4\"><a target=\"_blank\" rel=\"noopener noreferrer\""+(_vm._ssrAttr("href",_vm.siteMetadata.github))+" class=\"text-sm text-gray-500 transition hover:text-gray-600\"><span class=\"sr-only\">github</span> <img"+(_vm._ssrAttr("src",__webpack_require__(19)))+" class=\"w-8 h-8\"></a> <a target=\"_blank\" rel=\"noopener noreferrer\""+(_vm._ssrAttr("href",_vm.siteMetadata.linkedin))+" class=\"text-sm text-gray-500 transition hover:text-gray-600\"><span class=\"sr-only\">Linkedin</span> <img"+(_vm._ssrAttr("src",__webpack_require__(33)))+" class=\"w-8 h-8\"></a> <a target=\"_blank\" rel=\"noopener noreferrer\""+(_vm._ssrAttr("href",("mailto:" + (_vm.siteMetadata.email))))+" class=\"text-sm text-gray-500 transition hover:text-gray-600\"><span class=\"sr-only\">mail</span> <img"+(_vm._ssrAttr("src",__webpack_require__(34)))+" class=\"w-8 h-8\"></a></div> <div class=\"flex mb-2 space-x-2 text-sm text-gray-500 dark:text-gray-400\"><div>"+_vm._ssrEscape("Copyright © "+_vm._s(new Date().getFullYear()))+"</div> <div>•</div> <a href=\"/\">"+_vm._ssrEscape(_vm._s(_vm.siteMetadata.author)+"'s blog - "+_vm._s(_vm.siteMetadata.slogan))+"</a></div> <div class=\"flex mb-2 space-x-2 text-sm text-gray-500 dark:text-gray-400\"><img src=\"/department_logo.svg\" style=\"width: 300px !important\"></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/TheFooter.vue?vue&type=template&id=1e23a034&

// EXTERNAL MODULE: ./data/sitemetainfo.js
var sitemetainfo = __webpack_require__(13);
...
"use strict";
const siteMetaInfo = {
  title: "Yizhe ZHANG | Research Assistant",
  author: "Yizhe ZHANG",
  author_image: "/author.png",
  position: "Research Assistant | HKBU",
  location: "Hong Kong",
  headerTitle: "Yizhe ZHANG",
  slogan: "Recommender Systems",
  description: "Conversation Recommender Systems, Human-Computer Interaction, and Software Engineering",
  language: "en-us",
  theme: "system",
...
const _7081a40f = () => interopDefault(__webpack_require__.e(/* import() | pages/blog/index */ 8).then(__webpack_require__.bind(null, 80)));

const _1788fa64 = () => interopDefault(__webpack_require__.e(/* import() | pages/projects */ 10).then(__webpack_require__.bind(null, 78)));

const _6ecb02c7 = () => interopDefault(__webpack_require__.e(/* import() | pages/blog/_slug */ 7).then(__webpack_require__.bind(null, 79)));

const _3dded758 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 9).then(__webpack_require__.bind(null, 81)));
...
var prism_dracula = __webpack_require__(29);
...
const AuthorCard = () => __webpack_require__.e(/* import() | components/author-card */ 1).then(__webpack_require__.bind(null, 68)).then(c => wrapFunctional(c.default || c));
const AuthorIntro = () => __webpack_require__.e(/* import() | components/author-intro */ 2).then(__webpack_require__.bind(null, 71)).then(c => wrapFunctional(c.default || c));
const Expertise = () => __webpack_require__.e(/* import() | components/expertise */ 4).then(__webpack_require__.bind(null, 69)).then(c => wrapFunctional(c.default || c));
const ProjectCard = () => __webpack_require__.e(/* import() | components/project-card */ 5).then(__webpack_require__.bind(null, 67)).then(c => wrapFunctional(c.default || c));
...
const TimeLine = () => __webpack_require__.e(/* import() | components/time-line */ 6).then(__webpack_require__.bind(null, 70)).then(c => wrapFunctional(c.default || c));
const BlogItem = () => __webpack_require__.e(/* import() | components/blog-item */ 3).then(__webpack_require__.bind(null, 66)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
async function _imageMeta(url) {
  if (true) {
    const imageMeta2 = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(null, 45, 7)).then(r => r.default || r);
