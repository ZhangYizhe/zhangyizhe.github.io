...
module.exports.__inject__ = function (context) {
  add("d71ad70c", content, true, context)
};
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(4).default("67c6a6a2", content, true)
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(4).default("07245185", content, true)
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".nuxt-content h2{font-weight:700;font-size:28px}.nuxt-content h3{font-weight:700;font-size:22px}.nuxt-content p{margin-bottom:20px}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/_slug.vue?vue&type=template&id=48b3fea1&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"px-4 mx-auto sm:px-6 xl:max-w-5xl xl:px-0 mt-10"},[_vm._ssrNode("<p class=\"text-center font-bold my-5 text-indigo-500\">"+_vm._ssrEscape("\n    "+_vm._s(_vm.formatDate(_vm.article.date))+"\n  ")+"</p> <h1 class=\"text-4xl text-gray-700 font-extrabold mb-10 text-center\">"+_vm._ssrEscape("\n    "+_vm._s(_vm.article.title)+"\n  ")+"</h1> "),_vm._ssrNode("<div class=\"flex items-center font-medium mt-6 sm:mx-3 justify-center\">","</div>",[_c('nuxt-img',{staticClass:"mr-3 w-10 h-10 rounded-full bg-slate-50 dark:bg-slate-800",attrs:{"src":_vm.siteMetadata.author_image,"loading":"lazy","alt":""}}),_vm._ssrNode(" <div><div class=\"text-slate-900 dark:text-slate-200\">"+_vm._ssrEscape("\n        "+_vm._s(_vm.siteMetadata.author)+"\n      ")+"</div> <a target=\"_blank\""+(_vm._ssrAttr("href",_vm.siteMetadata.twitter))+" class=\"text-sky-500 hover:text-sky-600 dark:text-sky-400\">"+_vm._ssrEscape("\n        @"+_vm._s(_vm.siteMetadata.twitter_user)+"\n      ")+"</a></div>")],2),_vm._ssrNode(" <img"+(_vm._ssrAttr("src",_vm.article.image))+" class=\"mx-auto w-4/5 my-10 rounded-md drop-shadow-sm\"> "),_c('nuxt-content',{staticClass:"prose min-w-full p-10 mx-auto",attrs:{"document":_vm.article}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog/_slug.vue?vue&type=template&id=48b3fea1&

// EXTERNAL MODULE: external "prismjs"
var external_prismjs_ = __webpack_require__(37);
...
var prism_toolbar_ = __webpack_require__(38);

// EXTERNAL MODULE: external "prismjs/plugins/line-numbers/prism-line-numbers"
var prism_line_numbers_ = __webpack_require__(39);

// EXTERNAL MODULE: ./node_modules/prismjs/plugins/line-numbers/prism-line-numbers.css
var prism_line_numbers = __webpack_require__(72);

// EXTERNAL MODULE: external "prismjs/plugins/line-highlight/prism-line-highlight"
var prism_line_highlight_ = __webpack_require__(40);

// EXTERNAL MODULE: ./node_modules/prismjs/plugins/line-highlight/prism-line-highlight.css
var prism_line_highlight = __webpack_require__(74);

// EXTERNAL MODULE: external "prismjs/components/prism-bash.js"
var prism_bash_js_ = __webpack_require__(41);
